...
def stock_graph(ticker_input):
    ...
    config['session'] = True
    config['api_key'] = 'abacd49b744a4ceb8629e71acd5e8f6519b5cacf'
 # Add your own api key for tiingo https://api.tiingo.com/
    # setting client equal to the TiingoClient with the api key in config
    ...
    # setting dataframe with ticker, frequency, dates
    ...
    # Matlab plotting of graph and showing
